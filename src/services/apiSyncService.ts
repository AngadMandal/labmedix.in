...
export class ApiSyncService {
  ...
  public static readonly KEY_TO_FIRESTORE_MAP: Record<string, { type: 'collection' | 'doc'; path: string }> = {
    ...
    'labmedix_specimens_v1': { type: 'collection', path: 'specimens' },
    'labmedix_diagnostic_reports_v1': { type: 'collection', path: 'diagnosticReports' },
    'labmedix_lab_settings_v1': { type: 'doc', path: 'settings/laboratory' },
