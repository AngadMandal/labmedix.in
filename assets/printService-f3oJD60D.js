import{d as c}from"./index-DO0fodOj.js";class p{static printCR80Card(o,e,t="LABMEDIX CR80 PVC Card"){try{const n=window.open("","_blank","width=900,height=700");if(!n){window.print();return}const i=Array.from(document.querySelectorAll('style, link[rel="stylesheet"]')).map(l=>l.outerHTML).join(`
