import{d as l}from"./index-DzlWNGcJ.js";class p{static printCR80Card(i,o,t="LABMEDIX CR80 PVC Card"){try{const n=window.open("","_blank","width=900,height=700");if(!n){window.print();return}const r=Array.from(document.querySelectorAll('style, link[rel="stylesheet"]')).map(c=>c.outerHTML).join(`
...
`),r=i.outerHTML,a=`
      ...
      `;t.document.open(),t.document.write(a),t.document.close(),l.log("BILL_PRINTED","billing",`Printed Universal Half-Page Invoice: ${o}`)}catch(t){console.error("Error in printUniversalA4HalfPage:",t),window.print()}}}export{p as P};
